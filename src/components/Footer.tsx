...
const Footer = () => {
  ...
  return (
    <footer className="bg-yrealty-navy text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Premier property management company dedicated to maximizing your property's potential through exceptional service.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-yrealty-accent mr-3" />
                <span className="text-gray-300">(845) 734-3331</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-yrealty-accent mr-3" />
                <a href="mailto:info@theYteam.co" className="text-gray-300 hover:text-white transition-colors">
                  info@theYteam.co
                </a>
              </li>
            </ul>
            <a href="#contact" className="mt-6 inline-block px-5 py-2 bg-white text-yrealty-navy rounded-lg hover:bg-gray-100 transition-colors">
              Get in Touch
            </a>
          </div>
        </div>
      ...
      <button 
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 p-3 rounded-full bg-white text-yrealty-navy shadow-lg hover:bg-gray-100 transition-colors z-10"
