...
const HeroSection = () => {
  ...
  return <section id="home" ref={heroRef} aria-label="Welcome to Y Realty Team" className={`
    ...
    backgroundImage: isImageLoaded ? "url('https://images.unsplash.com/photo-1551361415-69c87624334f?auto=format&fit=crop&q=80&w=1920')" : 'none'
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl text-white">
          ...
          {/* Key benefits */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10 animate-fade-in" style={{
          animationDelay: '0.3s'
        }}>
