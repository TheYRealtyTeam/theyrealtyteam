...
const Vacancies = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Available Rental Units | Y Realty Team";
    
    const metaDesc = document.querySelector('meta[name="description"]') || document.createElement('meta');
    metaDesc.setAttribute('name', 'description');
    metaDesc.setAttribute('content', 'View available rental properties managed by Y Realty Team. Find your next home from our live inventory of quality rental units.');
    if (!metaDesc.parentElement) {
    ...
    <div className="w-full bg-white">
      ...
      <div className="pt-28 md:pt-32 pb-8 md:pb-12 bg-yrealty-blue">
        <div className="container-custom">
          <h1 className="text-4xl md:text-5xl font-bold text-yrealty-navy text-center">Available Rental Units</h1>
          <p className="text-center text-gray-600 mt-4 max-w-3xl mx-auto">
            Browse our current rental listings managed through AppFolio
          </p>
        </div>
      </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="w-full max-w-6xl mx-auto px-4 overflow-x-hidden pb-[env(safe-area-inset-bottom)]">
            {/* Page Header */}
